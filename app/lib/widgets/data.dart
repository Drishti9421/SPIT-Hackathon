...
List<PlanetInfo> planets = [
  PlanetInfo(1,
      name: 'Community',
      text: 'Volunteer for social cause',
  ...
  PlanetInfo(2,
      name: 'Shop',
      text: 'Shop Eco-Friendly products right here',
      iconImage: 'lib/images/shop.png',
      description:
  ...
  PlanetInfo(3,
      name: 'Classifier',
      text: 'Segregate between dry & wet waste.',
      iconImage: 'lib/images/image_classifier.png',
      description:
  ...
  // PlanetInfo(5,
  //     name: 'Jupiter',
  //     iconImage: 'lib/images/jupiter.png',
  //     description:
  ...
  // PlanetInfo(6,
  //     name: 'Saturn',
  //     iconImage: 'lib/images/saturn.png',
  //     description:
  ...
  // PlanetInfo(7,
  //     name: 'Uranus',
  //     iconImage: 'lib/images/uranus.png',
  //     description:
  ...
  // PlanetInfo(8,
  //     name: 'Neptune',
  //     iconImage: 'lib/images/neptune.png',
  //     description:
